...
export default function MusicPlayer({ playlistId, videoId }: MusicPlayerProps) {
  ...
  const embedUrl = playlistId
    ...
    : `https://www.youtube.com/embed/${defaultVideoId}?autoplay=1&loop=1&playlist=${defaultVideoId}&mute=${isMuted ? 1 : 0}&controls=0&modestbranding=1&rel=0`;
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      <div className="bg-white border-2 border-black p-2 flex flex-col gap-2">
        ...
        {/* Iframe de YouTube (oculto pero activo) */}
